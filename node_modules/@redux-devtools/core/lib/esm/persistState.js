...
export default function persistState(sessionId) {
  var deserializeState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity;
  var deserializeAction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : identity;
  ...
  function deserialize(state) {
    return _objectSpread(_objectSpread({}, state), {}, {
      actionsById: mapValues(state.actionsById, function (liftedAction) {
